...
~方法一（推荐）：修改版库街区一键获取token~

## 接群友提醒，该版本不公开发布，故删除

~本工具为基于库街区 3.1.2 版本逆向修改的 App，所有功能未动，仅在设置中增加了一个「获取token」选项，点击即可将 token 复制到剪切板。~
...
~1. 下载并安装上述修改版库街区~
~2. 正常登录库街区账号~
~3. 进入 App 设置，点击「获取token」~
~4. token 将自动复制到剪切板~

~获取 token 和 did 后，跳至下方「三、Bot登录」完成绑定即可。~

---

## 方法二：使用 ProxyPin 抓包（适用 3.0.1 版本库街区） {.wp-block-heading}

### 零、下载3.0.1 版本库街区 {.wp-block-heading}

📥 下载链接：<a href="https://imgbed.fufu.blog/file/site_pics/kuro_token/AiZ3KPN8.apk" target="_blank" rel="noopener">库街区v3.0.1</a>
